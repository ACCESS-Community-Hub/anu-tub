...
The model has $160 \times 800$ grid points, with a tile layout of $6 \times 40$ to run efficiently on 312 cores.
With a 1200-second timestep, the standard ZSTAR case takes approx 1:20 hours per year (~18 years/day) and consumes ~800 SU per model year.
